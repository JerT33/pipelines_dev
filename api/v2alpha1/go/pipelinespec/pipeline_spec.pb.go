...
type ComponentInputsSpec_ParameterSpec struct {
	...
	AllowedValues []*structpb.Value `protobuf:"bytes,6,rep,name=allowed_values,json=allowedValues,proto3" json:"allowed_values,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ComponentInputsSpec_ParameterSpec) GetAllowedValues() []*structpb.Value {
	if x != nil {
...
const file_pipeline_spec_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v23.ml_pipelines.DagOutputsSpec.DagOutputParameterSpecR\x05value:\x028\x01\"\xc9\a\n" +
	...
	"isOptional\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x1a\xeb\x02\n" +
	"\rParameterSpec\x12E\n" +
	...
	"\x0eallowed_values\x18\x06 \x03(\v2\x16.google.protobuf.ValueR\rallowedValues\x1al\n" +
	"\x0eArtifactsEntry\x12\x10\n" +
...
var file_pipeline_spec_proto_depIdxs = []int32{
	...
	116, // 78: ml_pipelines.ComponentInputsSpec.ParameterSpec.allowed_values:type_name -> google.protobuf.Value
